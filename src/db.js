import { initializeApp } from 'https://www.gstatic.com/firebasejs/8.2.10/firebase-app.js';
import { getFirestore } from 'https://www.gstatic.com/firebasejs/8.2.10/firebase-firestore.js';
